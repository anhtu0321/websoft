            ...
            <div class="col-sm-12 no-padding box-tin-body">
                <div class="col-sm-12 no-padding box-body-main">
                    <div class="col-sm-3 margin-bottom-5 box-body-left">
                        <a href="#"><img src="imguploads/<?php echo $rstintuc['anh']?>"></a>
                    </div>
                    <div class="col-sm-9 box-body-right">
                        <p class="right-title"><a href="#"><?php echo $rstintuc["tieude"];?></a><span class="ngay"> (18/05/2020)</span> </p>
                        <p class="right-info">
                            <?php 
                ...
                <div class="col-sm-12 body-bottom">
                    ...
                    ?>
                        <p class="p-link">
                            <a href="#"><?php echo $rstintuc["tieude"];?></a>
